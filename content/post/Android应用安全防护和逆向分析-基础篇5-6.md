...
![img](http://my-md-1253484710.coscd.myqcloud.com/20180829165213.png)
...
![img](http://my-md-1253484710.coscd.myqcloud.com/20180829200453.png)

![img](http://my-md-1253484710.coscd.myqcloud.com/20180829200408.png)
...
- **资源索引表的头部信息**
	...
	![img](http://my-md-1253484710.coscd.myqcloud.com/20180829204728.png)



- **资源项的值字符串资源池**接着头部的的是两个偏移数组，分别是字符串偏移数组和字符串样式偏移数组。这两个偏移数组的大小分别等于stringCount和styleCount的值，而每一个元素的类型都是无符号整型。整个字符中资源池结构如下。
	...
	![img](http://my-md-1253484710.coscd.myqcloud.com/20180829205108.png)
...
- **Package数据块**
	...
	![img](http://my-md-1253484710.coscd.myqcloud.com/20180829205652.png)
