...
![img](https://my-md-1253484710.file.myqcloud.com/20200403011045.png)
...
![img](https://my-md-1253484710.file.myqcloud.com/20200403015253.png)
...
![img](https://my-md-1253484710.file.myqcloud.com/20200403012851.png)

chunk元数据中mapmisc中的bitmap结构管理着run中的region的分配使用：

![img](https://my-md-1253484710.file.myqcloud.com/20200403013355.png)

chunk

![img](https://my-md-1253484710.file.myqcloud.com/20200403015412.png)
...
![img](https://my-md-1253484710.file.myqcloud.com/20200403022314.png)
...
![img](https://my-md-1253484710.file.myqcloud.com/20200403022557.png)

可以看到一共两个arenas，每个arena有36个bin，一共2个chunk。

### 查看chunks

![img](https://my-md-1253484710.file.myqcloud.com/20200403023042.png)

单个chunk，查看chunk中的run

![img](https://my-md-1253484710.file.myqcloud.com/20200403023253.png)

查看runs，会列出单前所有的run的详情 run_siez = region_size*no_regions

![img](https://my-md-1253484710.file.myqcloud.com/20200403023401.png)

只显示单前运行中的run

是否是allocated状态是根据arena_chunk_map_bits_s 对应 bits的 第 [0] bit 来确定 这里jemalloc5 和 jemalloc4 3不一样。

![img](https://my-md-1253484710.file.myqcloud.com/20200403023454.png)

查看单个run的详情：

![img](https://my-md-1253484710.file.myqcloud.com/image-20200403023549875.png)

run的布局如下：

![img](https://my-md-1253484710.file.myqcloud.com/20200405030548.png)
...
![img](https://my-md-1253484710.file.myqcloud.com/20200403023802.png)
...
![img](https://my-md-1253484710.file.myqcloud.com/20200405031010.png)

大小都是0x8

按大小查找：第4个：

![img](https://my-md-1253484710.file.myqcloud.com/20200405031343.png)
...
![img](https://my-md-1253484710.file.myqcloud.com/20200405034722.png)

![img](https://my-md-1253484710.file.myqcloud.com/20200405034659.png)

![img](https://my-md-1253484710.file.myqcloud.com/20200405190426.png)
...
![img](https://my-md-1253484710.file.myqcloud.com/20200405190147.png)

- Run overflow

![img](https://my-md-1253484710.file.myqcloud.com/20200405190224.png)

- Chunk overflow

![img](https://my-md-1253484710.file.myqcloud.com/20200405190305.png)
